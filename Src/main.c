...
static void MX_ADC2_Init(void)
{
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC2, LL_ADC_CHANNEL_13, LL_ADC_SAMPLINGTIME_12CYCLES_5);
...
static void MX_DAC3_Init(void)
{
  ...
  */
  if (HAL_DACEx_SawtoothWaveGenerate(&hdac3, DAC_CHANNEL_2, DAC_SAWTOOTH_POLARITY_DECREMENT, 4000, 66) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_HRTIM1_Init(void)
{
  ...
  pBurstModeCfg.IdleDuration = 20;
  pBurstModeCfg.Period = 20;
  ...
  pCompareCfg.CompareValue = 26112;
  ...
  pDeadTimeCfg.RisingValue = 12;
  pDeadTimeCfg.RisingSign = HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE;
  pDeadTimeCfg.RisingLock = HRTIM_TIMDEADTIME_RISINGLOCK_WRITE;
  pDeadTimeCfg.RisingSignLock = HRTIM_TIMDEADTIME_RISINGSIGNLOCK_WRITE;
  pDeadTimeCfg.FallingValue = 12;
  ...
  pOutputCfg.ResetSource = HRTIM_OUTPUTSET_EEV_1|HRTIM_OUTPUTRESET_TIMCMP1;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(CTRLOOP_DBG_PULSE_GPIO_Port, CTRLOOP_DBG_PULSE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EEPROM_SCL_GPIO_Port, EEPROM_SCL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EEPROM_SDA_Pin|LED_RED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : KEY_B_Pin KEY_C_Pin KEY_D_Pin */
  GPIO_InitStruct.Pin = KEY_B_Pin|KEY_C_Pin|KEY_D_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : CTRLOOP_DBG_PULSE_Pin */
  GPIO_InitStruct.Pin = CTRLOOP_DBG_PULSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CTRLOOP_DBG_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : EEPROM_SDA_Pin */
  ...
  /*Configure GPIO pins : SW1_Pin SW2_Pin KEY_A_Pin */
  GPIO_InitStruct.Pin = SW1_Pin|SW2_Pin|KEY_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
